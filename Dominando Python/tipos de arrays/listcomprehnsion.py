# list comprenhsion um for na mesma linha 

# def calcularImpostos(preco,imposto ):
#     return preco * imposto


# preco_produtos = [100,150,300,5500]
# imposto = [calcularImpostos(preco,0.3) for preco in preco_produtos]
# print(f"preço {imposto}")



# vendas_produtos2019 = [1500,150,2100,19050]
# produtos = ['tv','cafeteira','geladria','carro']
# lista_auxilizar = list(zip(produtos,vendas_produtos2019))
# lista_auxilizar.sort(reverse=True)
# print("Listas juntadas :{}".format(lista_auxilizar))
# print("---------------------")
# mais_vendidos = [prd  for prd ,vds  in lista_auxilizar]
# print(mais_vendidos)

#Exercicio de List Comprehension 1 

# vendas_produtos = [('iphone', 558147, 951642), ('galaxy', 712350, 244295), ('ipad', 573823, 26964), ('tv', 405252, 787604), ('máquina de café', 718654, 867660), ('kindle', 531580, 78830), ('geladeira', 973139, 710331), ('adega', 892292, 646016), ('notebook dell', 422760, 694913), ('notebook hp', 154753, 539704), ('notebook asus', 887061, 324831), ('microsoft surface', 438508, 667179), ('webcam', 237467, 295633), ('caixa de som', 489705, 725316), ('microfone', 328311, 644622), ('câmera canon', 591120, 994303)]

# lista_maioresvendas2019 = [ (produto,venda_2019)  for produto,venda_2019,venda_2020 in vendas_produtos]


# maior_venda =  max(lista_maioresvendas2019)
# print(f" Maiores venda de 2019: {maior_venda}")
# print('-------------------------------------')

# lista_produto = [produtos for produtos,venda2019,venda2020 in vendas_produtos]
# maior_produto = max(lista_produto)

# meta = 1000
# vendas_produtos = [1500,150,2100,1950,2999]
# produtos = ["Macboook","Tv","Iphone","Computador Gamer","notebook"]

# #todo produto acima da meta vai ser mostrado
# produtos_acima_da_meta = [produto for i,produto in enumerate(produtos) if vendas_produtos[i] > meta]
# print("----------")
...
# lista_inadiplentes = [(cpf) for cpf, valor , dias in clientes_devedores  if dias > 20]
# print(f"CPF: {lista_inadiplentes} \n ")
...
#     if qtd < 200:
#        resultado += f"{produto} tem {qtd},precisa fazer um pedido com 1000 unidades \n clea\n"
#        lista.append(resultado)
#     else:
#         resultado += f"{produto} tem {qtd},precisa fazer um pedido com 500 unidades \n \n"
#         lista.append(resultado)
...
# # duas maneira de fazer o calculo de top total de vendas

# for i,produto in enumerate(produtos):
#     if produto in top5:
#         total_top5 += vendas[i]

# print(f"{(total_top5 / sum(vendas)):.0%}")
        

# total_top5 = sum(vendas[i] for i,produto in enumerate(produtos) if produto in top5)

# print(f" Total de vendas o top 5 representou: {(total_top5 / sum(vendas)):.0%}")
