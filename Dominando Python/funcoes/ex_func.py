...
# carga = carga_tributaria(1500,400,800)
# print(f"{carga:.0%}")
...
# def cliente_negativado(cliente):
#     clientes = ''
#     clientes_inadiplente_nao = ''
#     for item in cliente:
#         cpf , valor , dias = item
#         if valor >= 1000 and dias >= 20:
#             clientes += (f'O cliente {cpf} esta negativado com mais de {dias} dias e devendo R$ {valor:,.2f}\n')
#         # elif valor >= 2000 and dias >= 10:
#         #     clientes  += (f'O cliente {cpf} não esta negativado com mais de {dias} dias e devendo R$ {valor:,.2f}\n')
#         # elif valor >= 500 and dias >= 40:
#         #     clientes  += (f'O cliente {cpf} não esta negativado com mais de {dias} dias e devendo R$ {valor:,.2f}\n')

#     return clientes


# banco = cliente_negativado(clientes_devedores)
# print(banco)
...
# def calc_perc(metas,venda):
#     lista_vendedores = []
#     bateram_meta = 0
#     for item in venda:
#         if(venda[item] >= meta):
#             lista_vendedores.append(item)
#             bateram_meta = len(lista_vendedores) / len(venda)

#     return (lista_vendedores,f"{bateram_meta:.0%}")



# meta = 10000
# vendas = {'jogao':15000,'Julia':27000,'Marcus':25000,'Breno':36999,'Ana':10370,'Alon':7469,'Bernado':3299}

# teste = calc_perc(meta,vendas)
# print(teste)

# Modelo de previsao de moveis 

# def dividirLista(preco,tamanho,fator = 0.3):
...
# print(dividirLista(precos_imoveis,tamanho_imoveis))
# print('-*-------------------------------------------')

# teste_treino ,teste_preco , tamnho_treino , tamano_teste = dividirLista(precos_imoveis,tamanho_imoveis)
# print(f"Lista de treino: \n {teste_treino}  -  tamanho da lista: {len(teste_treino)} \n\n")
# print(f"Lista de preco teste {teste_preco} -  tamanho da lista: {len(teste_preco)}  \n\n")
# print(f"Lista de tamanhos treino: {tamnho_treino} -  tamanho da lista: {len(tamnho_treino)}  \n\n")
# print(f"Lista de tamanho teste: {tamano_teste} -  tamanho da lista: {len(tamano_teste)} ")
...
def Montar_lista(*lista):
    ...
    for item in lista:
        for produto in item:
            lista_nova.append(produto)
    lista_nova = set(lista_nova)
...
print(len(Montar_lista(estoque_fim_jan,estoque_fim_fev,estoque_fim_mar,estoque_fim_abr)))